...
INSERT INTO job_listings ("Id", "Title", "Description", "CompanyId", "Location", "Type", "SalaryMin", "SalaryMax", "PostedAt", "IsActive", "ClosingDate") VALUES
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Senior Frontend Software Engineer', 'We are looking for a talented Senior Frontend Engineer to join our growing team. You will work closely with cross-functional teams to deliver high-quality solutions.', 'aaaaaaaa-0000-0000-0000-000000000001'::uuid, 'Cape Town',             0, 30000,  45000,  NOW(),                      true,  NOW() + INTERVAL '30 days'),
  ('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'Junior Systems Developer',           'We are looking for a Junior Systems Developer to join our growing team. Experience with modern tooling and agile practices is essential.',                              'aaaaaaaa-0000-0000-0000-000000000002'::uuid, 'Johannesburg, Sandton', 0, 15000,  30000,  NOW() - INTERVAL '3 days',  true,  NOW() + INTERVAL '30 days'),
  ('c3d4e5f6-a7b8-9012-cdef-123456789012', 'UX/Web Designer',                   'We are looking for a creative UX/Web Designer to join our team. You will work closely with product and engineering to deliver great user experiences.',                  'aaaaaaaa-0000-0000-0000-000000000003'::uuid, 'Sandton',               2, 10000,  18000,  NOW() - INTERVAL '10 days', true,  NOW() + INTERVAL '30 days'),
  ('d4e5f6a7-b8c9-0123-defa-234567890123', 'Data Analyst Intern',               'We are looking for a Data Analyst Intern to support our analytics team. This is a great opportunity for a recent graduate.',                                           'aaaaaaaa-0000-0000-0000-000000000004'::uuid, 'Pretoria/Hybrid',       3, 15000,  22000,  NOW() - INTERVAL '45 days', false, NOW() - INTERVAL '5 days'),
  ('e5f6a7b8-c9d0-1234-efab-345678901234', 'Senior DevOps Engineer',            'We are looking for a Senior DevOps Engineer to join our infrastructure team. Experience with CI/CD pipelines and cloud platforms is essential.',                        'aaaaaaaa-0000-0000-0000-000000000005'::uuid, 'Bloemfontein',          0, 70000,  110000, NOW() - INTERVAL '2 days',  true,  NOW() + INTERVAL '30 days'),
  ('f6a7b8c9-d0e1-2345-fabc-456789012345', 'Part-Time Content Writer/Promoter', 'We are looking for a creative Part-Time Content Writer to join our media team. You will create engaging content across multiple platforms.',                            'aaaaaaaa-0000-0000-0000-000000000006'::uuid, 'Remote',                1, 12000,  18000,  NOW() - INTERVAL '60 days', true,  NOW() + INTERVAL '30 days');