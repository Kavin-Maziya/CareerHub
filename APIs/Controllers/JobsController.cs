...
//         // // Prevent duplicate job listing for the same company
...
//         // var response = MapToListResponse(newJob, company.CompanyName);
...
//         var response = MapToListResponse(existing, company.CompanyName);
...
//     private static JobListResponse MapToListResponse(JobListing job, string companyName) => new(
//         Id: job.Id,
//         Title: job.Title,
